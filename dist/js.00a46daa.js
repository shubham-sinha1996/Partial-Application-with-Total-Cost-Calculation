...
module.exports = [{
  "id": 1,
  "product": "Whiskers Kitten Food",
  "cost": 35.5,
  "shipping": 2.25,
  "category": "petfood"
}, {
  "id": 2,
  "product": "Cute Paws Adult Cat Food",
  "cost": 50.25,
  "shipping": null,
  "category": "petfood"
}, {
  ...
  "id": 4,
  "product": "FlickPhone GX30 Smartphone",
  "cost": 950,
  "shipping": null,
  "category": "smartphones"
}, {
  "id": 5,
  "product": "PixelPerfect 32 SmartTV (Android)",
  "cost": 1250,
  "shipping": null,
  "category": "televisions"
}, {
  "id": 6,
  "product": "PixelPerfect 43 SmartTV (Android)",
  "cost": 1820,
  "shipping": null,
  "category": "televisions"
}];
...
var _default = (product, cost, totalCost) => `<div class="product">
...
const renderRows = function (items) {
  const domNodes = items.map(({
    product,
    cost,
    totalCost = 'N/A'
  }) => (0, _Row.default)(product, cost, totalCost)).join('');
...
(function () {
  const revised = _data.default.map(item => {
    console.log(shipping[item.category](item.cost));
    return {
      ...item,
      totalCost: !item.shipping ? shipping[item.category](item.cost) : ['petfood', 'smartphones'].includes(item.category) ? tax.tax12(item.shipping, item.cost) : tax.tax18(item.shipping, item.cost)
    };
  });
  renderRows(revised);
})();
},{"./data.json":"js/data.json","./Row":"js/Row.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
